...
export const WHAT_YOU_GET_COPY = {
  ...
  items: [
    ...
    },
    {
      ...
      desc: "Cualquier nueva sesión, actualización de gráficos o dinámicas de juego añadidas al pack será tuya sin pagar un solo dólar más.",
...
export const TESTIMONIALS_DATA: Testimonial[] = [
  {
    ...
    rating: 5,
    quote: "Mis niños estaban desesperados con los mismos entrenamientos mecánicos de siempre. Al aplicar las dinámicas sociomotrices de este pack, la motivación explotó. Hoy nos coronamos campeones de la liga municipal de Cali. No exagero, la planificación me toma literalmente 5 minutos al día.",
